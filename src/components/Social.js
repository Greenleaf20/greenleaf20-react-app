function Social() {
    return (
        <div className="route-outer">
            ...
            <img className="social-pics-l" alt="2021 reading challenge" src="/assets/images/social/2021-reading.png"/>
            <img className="social-pics-p" alt="Jane Austen award" src="/assets/images/social/jane-austen-award.jpeg"/>
            </div>
            <p>
            ...
            <div className="social-pics-div">
            <img className="social-pics-p" alt="archana with dogs" src="/assets/images/social/archana-dogs.jpeg"/>
