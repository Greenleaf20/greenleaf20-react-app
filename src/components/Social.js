function Social() {
    return (
        <div className="route-outer">
            <h2 class="heading" id="social">Something fun about me!</h2><hr/>
            <p>
            ...
            <div class="social-pics-div">
            <img class="social-pics-p" src="/assets/images/social/nc-museum.jpeg"/>
            <img class="social-pics-p" src="/assets/images/social/dino-footprint.jpeg"/>
            </div>
        </div>
    );
}
