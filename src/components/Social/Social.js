    ...
    return (
        <div className="route-outer">
            ...
            <div className='panel-item'>
                ...
                <div className="social-pics-div">
                    <img className="social-pics" alt="NC museum of natural science" src="/assets/images/social/nc-museum.jpeg"/>
                    <img className="social-pics" alt="dino footprint reservation" src="/assets/images/social/dino-footprint.jpeg"/>
                </div>
                <div className="social-pics-div">
                    <img className="social-pics" alt="dino footprint reservation" src="/assets/images/social/archana-american-museum.jpeg"/>
                </div>
            </div>
        </div>
    );
